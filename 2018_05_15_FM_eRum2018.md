...
author: "**Federico Marini** (marinif@uni-mainz.de)</br>
  ...
  </br><!--html_preserve--><i class="fa  fa-twitter "></i><!--/html_preserve--> `@FedeBioinfo`</br>"
...
<!--html_preserve--><i class="fa  fa-twitter "></i><!--/html_preserve--> `@FedeBioinfo`
...
## Workflow/demo quick {.build .smaller}
...
<code>marinif@uni-mainz.de</code> - <!--html_preserve--><i class="fa  fa-twitter "></i><!--/html_preserve--> `@FedeBioinfo`
</p>
</div>
