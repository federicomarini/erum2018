...
<p align="center">
You can find this presentation here: [`https://github.com/federicomarini/erum2018`](https://github.com/federicomarini/erum2018)
</p>
...
`scfull_pcaexplorer_ideal.mov`, also at https://www.youtube.com/watch?v=EckimPqRcCg
...
<p align="center">
<img src="isee_rafiki_v2.png" alt="" height="300"/>
</p>
...
Or just visit `http://shiny.imbei.uni-mainz.de:3838/iSEE_PBMC4k`
...
<!-- ![](https://i.imgflip.com/29v8hl.jpg) -->
...
> - Fellowship output focus on Thrombosis & Hemostasis, enabling analysis workflows of high-dimensional data: *platelet-o-pedia* portal as unique landing point, lower barriers to genomic data exploration
