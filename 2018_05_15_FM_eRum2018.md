...
author: "**Federico Marini** (<code>marinif@uni-mainz.de</code>)</br>
  ...
  </br><!--html_preserve--><i class="fab  fa-twitter "></i><!--/html_preserve--> [`@FedeBioinfo`](https://twitter.com/FedeBioinfo)</br>"
...
We wanted: interactivity, linked information across plots, reproducibility, hammer for many nails
